...
```{r, echo = F, fig.height=3, fig.show='hold', fig.cap= "MCAR", warning=FALSE}
set.seed(123)
par(mfrow = c(2,2))
...
```{r, echo = F, fig.height=3, fig.show='hold', fig.cap= "MAR"}
set.seed(123)
par(mfrow = c(2,2))
...
```{r, echo = F, fig.height=3, fig.show='hold', fig.cap= "MNAR"}
set.seed(123)
par(mfrow = c(2,2))
