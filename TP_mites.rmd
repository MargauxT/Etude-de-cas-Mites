...
$$logit(\hat{\pi})= - 0.583 - 0.022*WatrCont +0.173*SubsDens + 2.738*TopoHummock$$
...
$$logit(\hat{\pi})=-4.23 -0.006*WatrCont+0.029*SubsDens+0.729*TopoHummock$$
...
Le modele selectionné s'écrit donc : $$ln(\lambda)=\beta_0+\beta_1*WatrCont+\beta_2*SubsDens+\beta_3*TopoHummock$$ ce qui nous donne à l'aide du `summary` de notre modèle : $$ln(\lambda)=0.710-0.008*WatrCont+0.034*SubsDens + 0.892*TopoHummock $$
