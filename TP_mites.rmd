...
Modéliser l'abondance de l'espèce Galumna en fonction des caractéristiques du substrat (son contenu en eau 'WartCont' et sa densité 'SubsDens') et si nécessaire des autres variables environmentales.
...
modele : $ln(Y)=\beta_O+\beta_1*WatrCont+\beta_2*SubsDens$ ? 
