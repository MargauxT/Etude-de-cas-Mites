...
```{r, echo = F, warning = F, fig.height=5, fig.cap="Pourcentage de données manquantes"}
...
```{r, echo = F, fig.height=5, fig.cap="Répartition des données manquantes"}
...
```{r, echo = F, fig.height=5, fig.cap="Imputation simple par régression stochastique"}
set.seed(122)
...
```{r, echo = F, fig.height=5, fig.cap= "Imputation multiple par régression stochastique"}
set.seed(123)
...
```{r, echo = F, fig.height=5, fig.cap= "Imputation multiple par régression"}
set.seed(124)
...
```{r, echo = F, fig.height=5, fig.cap= "Evolution de la moyenne de Y"}
...
**Analyse muldimentionnelle** `MCA` du package `FactoMineR` pour l'analyse multidimensionnelle
...
**Imputation simple** (Moyenne, médiane, mode, LOVC, kNN, loess, SVD, missForests -\> faire les méthodes adaptées)
